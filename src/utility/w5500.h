...
#define SPI_ETHERNET_SETTINGS SPISettings(14000000, MSBFIRST, SPI_MODE0) //W5100 support, SLOW
//#define SPI_ETHERNET_SETTINGS SPISettings(30000000, MSBFIRST, SPI_MODE0) //W5500 only, FAST


// Require Ethernet.h, because we need MAX_SOCK_NUM
#ifndef ethernetspi2_h_
#error "EthernetSPI2.h must be included before w5500.h"
#endif
